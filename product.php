...
<input class="form-control border px-2" type="text" require name="pname" placeholder="Enter product name...">
</div>

<div class="col-6 m-auto py-2" >
<input class="form-control border px-2" type="number" require name="pprice" placeholder="Enter product price...">
</div>

<div class="col-6 m-auto py-2" >
<input class="form-control border px-2" type="number" require name="pquantity" placeholder="Enter product quantity...">
</div>

<div class="col-6 m-auto py-2" >
<input class="form-control border px-2" type="file" require name="pimage">
</div>

<div class="col-6 m-auto py-2" >

<select class="form-control border px-2" name="pcategory" >
<?php
...
?>
    <tr>
        ...
        <td>
            <a class="btn btn-danger" href="product_delete.php?id=<?php echo $rows['c_id']?>">Delete</a> 
            <a class="btn btn-success" href="product_update.php?id=<?php echo $rows['c_id']?>">Update</a>
